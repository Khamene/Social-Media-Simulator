...
//    }
    ...
    public static void showChat(String user1, String user2) {
            String query = String.format("SELECT MESSAGES.MESSAGEID, USER1, MESSAGES.CONTENT, REPLYMESSAGES.CONTENT FROM MESSAGES LEFT JOIN" +
                    ...
                    " OR (USER2 = \"%s\" AND USER1 = \"%s\")", user1, user2, user1, user2);
    ...
    public static void showChat(String groupID) {
        String query = String.format("SELECT MESSAGES.MESSAGEID, USER1, MESSAGES.CONTENT, REPLYMESSAGES.CONTENT FROM MESSAGES LEFT JOIN" +
                " REPLYMESSAGES ON MESSAGES.REPLIEDMESSAGEID = REPLYMESSAGES.MESSAGEID WHERE GROUPID = \"%s\"", groupID);
    ...
    public static int setReply(String formerMessageID, String newMessageID) {
        ...
        try {
            ...
            query = String.format("SELECT CONTENT FROM MESSAGES WHERE FORMERMESSAGEID = \"%s\"", formerMessageID);
    ...
    public static String getContent(String messageID)  {
        String query = String.format("SELECT CONTENT FROM MESSAGES WHERE MESSAGEID = \"\"", messageID);
    ...
    public static int editMessage(String messageID, String senderID, String content) {
        String query = String.format("SELECT MESSAGEID, FORWARDED FROM MESSAGES WHERE USER1 = \"%s\" ORDERBY MESSAGEID DESC LIMIT 10", senderID);
