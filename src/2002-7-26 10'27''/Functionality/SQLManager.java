...
public class SQLManager {
    ...
    public static void createPersonalUser(String userID, String username, String password) {
        String query = String.format("INSERT INTO USERS (ID, USERNAME, PASSWORD, USERTYPE, DATECREATED) VALUES" +
                " (\"%s\", \"%s\", \"%s\", \"P\", \"%s\")", userID, username, password, LocalDateTime.now().toString());
    ...
    public static void createBusinessUser(String userID, String username, String password) {
        String query = String.format("INSERT INTO USERS (ID, USERNAME, PASSWORD, USERTYPE, DATECREATED) VALUES" +
                " (\"%s\", \"%s\", \"%s\", \"B\", \"%s\")", userID, username, password, LocalDateTime.now().toString());
