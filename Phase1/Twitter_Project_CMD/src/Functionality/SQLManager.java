...
public class SQLManager {
    static String url = "jdbc:mysql://localhost:3306/twitter1";
    ...
    public static void initialize() {
        ...
        try {
            String query = String.format("SELECT ID FROM USERS WHERE USERTYPE = \"P\"");
            ...
            query = String.format("SELECT ID FROM USERS WHERE USERTYPE = \"B\"");
            ...
            query = String.format("SELECT MESSAGEID FROM MESSAGES WHERE MESSAGETYPE = \"D\"");
            ...
            query = String.format("SELECT MESSAGEID FROM MESSAGES WHERE MESSAGETYPE = \"G\"");
            ...
            query = String.format("SELECT POSTID FROM POSTS");
