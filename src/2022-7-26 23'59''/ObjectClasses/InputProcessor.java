...
//show from sql
    ...
    public void directMessage(String receiverUserName){
        ...
        } catch (NoUserLoggedInException | UserDoesNotExistException | MessageContentNullException | UserWasBannedException e) {
            e.printStackTrace();
        }
    ...
    public void sendDM(String textDM,String receiver){
        ...
        } catch (NoUserLoggedInException | UserDoesNotExistException | UserWasBannedException | MessageContentNullException e) {
            e.printStackTrace();
        }
    }
    public void sendGroupMessage(String textGroupMessage,String receivingGroup){
        ...
        } catch (NoUserLoggedInException | GroupDoesNotExistException | UserDoesNotExistException | MessageContentNullException | UserNotMemberException | UserWasBannedException e) {
            e.printStackTrace();
        }
    }
