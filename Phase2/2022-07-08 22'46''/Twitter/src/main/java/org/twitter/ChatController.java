        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                if (App.theme.getValue() == 0) {
                    ...
                    notePhoto.setImage(new Image(String.valueOf(this.getClass().getResource("darkModeNotificationsIcons.png"))));
                    messagePhoto.setImage(new Image(String.valueOf(this.getClass().getResource("darkModeChatsIcons.png"))));
                    setPhoto.setImage(new Image(String.valueOf(this.getClass().getResource("darkModeSettingsIcons.png"))));
                    insightPhoto.setImage(new Image(String.valueOf(this.getClass().getResource("darkModeInsightsIcons.png"))));
                    homePhoto.setImage(new Image(String.valueOf(this.getClass().getResource("darkModeHomeIcons.png"))));
                ...
                if (!typeField.getText().equals("")) {
                    if (kp.getCode().equals(KeyCode.ENTER)) {
                        if (myChat.getGroup()) {
                            ...
                            catch (NoUserLoggedInException | UserDoesNotExistException | UserWasBannedException | MessageContentNullException | UnauthorisedEditException e) {
                                e.printStackTrace();
                            }
                        }
                    }
