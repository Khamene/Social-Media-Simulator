...
public class Group {
    ...
    ArrayList<Boolean> banned;
    ArrayList<String> profilePhotos;
    ArrayList<String> adminsID;

    public Group(String groupName, String ownerID, int memberCount, ArrayList<String> usersID,
                 ArrayList<String> adminsID, ArrayList<String> profilePhotos, ArrayList<Boolean> banned) {
    ...
    public static Group getGroup(String groupName) throws IllegalAccessException {
        try {
            return SQLManager.getGroup(groupName);
        }
    ...
    public ArrayList<Boolean> getBanned() { return banned; }

    public ArrayList<String> getAdminsID() {
        return adminsID;
    }

    public ArrayList<String> getProfilePhotos() {
    ...
    public static void addMember(String memberID, String attemptorID, String groupName) throws UserNotAdminException, GroupDoesNotExistException, UserDoesNotExistException, NullPointerException, UnauthorisedEditException {
        String groupID = Group.getGroupID(groupName);
        ...
        try {
            ...
            try {
                User.checkFollowedAccount(memberID, attemptorID);
            }
            catch (UnauthorisedEditException e) {
                throw new UnauthorisedEditException("You can not add this user to your group");
            }
