...
public class CreateAccountController implements Initializable {
    ...
    ChangeListener<Number> listener2 = new ChangeListener<Number>() {
        ...
        public void changed(ObservableValue<? extends Number> observableValue, Number number, Number t1) {
            if ((int) t1 == 0) {
                ...
                App.getScene().getStylesheets().add(this.getClass().getResource("LightModeCreateAccount.css").toExternalForm());
            }
            else if ((int) t1 == 1) {
                App.getScene().getStylesheets().clear();
                App.getScene().getStylesheets().add(this.getClass().getResource("DarkModeCreateAccount.css").toExternalForm());
            }
        }
    };
    ...
    ChangeListener<Boolean> listener3 = new ChangeListener<Boolean>() {
        ...
        public void changed(ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, Boolean t1) {
            if (t1) {
                myScene.heightProperty().removeListener(listener);
                myScene.widthProperty().removeListener(listener);
                App.theme.removeListener(listener2);

                myScene.widthProperty().addListener(listener);
                myScene.heightProperty().addListener(listener);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                myScene.focusedProperty().addListener(listener3);
