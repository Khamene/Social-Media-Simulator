...
//show from sql
    ...
    public void sendDM(String textDM,String receiver){
        ...
        } catch (NoUserLoggedInException | UserDoesNotExistException | MessageContentNullException |
                UserWasBannedException e) {
            e.printStackTrace();
        }
    }
    public void sendGroupMessage(String textGroupMessage,String receivingGroup){
        ...
        } catch (NoUserLoggedInException | GroupDoesNotExistException | MessageContentNullException |
                UserWasBannedException | UserDoesNotExistException | UserNotMemberException e) {
            e.printStackTrace();
        }
    }
