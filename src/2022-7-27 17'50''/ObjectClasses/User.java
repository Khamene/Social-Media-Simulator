...
public abstract class User {
    ...
    public static void sendDirectMessage(String receiverUsername, String content) throws NoUserLoggedInException,
            UserDoesNotExistException, UserWasBannedException, MessageContentNullException{
        if (LoggedInUsername == null)
            throw new NoUserLoggedInException("No user logged in yet...");
    ...
    public static void sendGroupMessage(String groupID, String content) throws NoUserLoggedInException,
            UserDoesNotExistException, MessageContentNullException, UserNotMemberException, UserWasBannedException {
        if (LoggedInUsername == null)
            throw new NoUserLoggedInException("No user logged in yet...");
    ...
    public static void forwardDMessage(String messageID, String receiverID) throws NoUserLoggedInException, UserDoesNotExistException
            , MessageNotIntendedForUserException, MessageDoesNotExistException, MessageContentNullException, UserWasBannedException {
        if (LoggedInUsername == null)
            throw new NoUserLoggedInException("No user logged in yet...");
    ...
    public static void forwardGMessage(String messageID, String groupID) throws NoUserLoggedInException, UserDoesNotExistException
            , MessageNotIntendedForUserException, MessageDoesNotExistException, MessageContentNullException, UserWasBannedException, UserNotMemberException {
        if (LoggedInUsername == null)
            throw new NoUserLoggedInException("No user logged in yet...");
    ...
    public static void replyDMessage(String formerMessageID, String content) throws NoUserLoggedInException,
            UserDoesNotExistException, UserWasBannedException, MessageContentNullException, MessageDoesNotExistException, MessageNotIntendedForUserException {
        if (LoggedInUsername == null)
            throw new NoUserLoggedInException("No user logged in yet...");
    ...
    public static void replyGMessage(String formerMessageID, String content) throws NoUserLoggedInException,
            UserDoesNotExistException, UserWasBannedException, MessageContentNullException, MessageDoesNotExistException, UserNotMemberException, MessageNotIntendedForUserException {
