...
//show from sql
    ...
    public void sendDM(String textDM,String receiver){
        ...
        } catch (NoUserLoggedInException | UserDoesNotExistException | MessageContentNullException | UserWasBannedException | MessageDoesNotExistException | MessageNotIntendedForUserException e) {
            e.printStackTrace();
        }
    }
    public void sendGroupMessage(String textGroupMessage,String receivingGroup){
        ...
        } catch (NoUserLoggedInException | GroupDoesNotExistException | MessageContentNullException | UserWasBannedException | UserDoesNotExistException | UserNotMemberException | MessageDoesNotExistException | MessageNotIntendedForUserException e) {
            e.printStackTrace();
        }
    }
    ...
    public void forwardMessageProgress(String messageID){
        ...
        if(yesNoAnswer.equalsIgnoreCase("yes")){
            ...
            } catch (NoUserLoggedInException | UserDoesNotExistException | MessageNotIntendedForUserException | GroupDoesNotExistException | MessageDoesNotExistException | MessageContentNullException | UserWasBannedException | UserNotMemberException e) {
                e.printStackTrace();
            }
        }
        if(yesNoAnswer.equalsIgnoreCase("No")){
            ...
            } catch (NoUserLoggedInException | MessageNotIntendedForUserException | UserDoesNotExistException | MessageDoesNotExistException | MessageContentNullException | UserWasBannedException e) {
                e.printStackTrace();
            }
        }
    }
